...
function EditProfile() {
  ...
  const handleEditProfile = async () => {
    ...
    try {
      ...
      const result = await axiosInstance.post(`/user/editProfile`, formdata);
  ...
  return (
    <div className="w-full min-h-[100vh] bg-gradient-to-b from-[#0a0f2c] via-[#1a103d] to-[#120021] flex items-center flex-col gap-[20px] ">
      ...
      <input
        type="text"
        className="w-[90%] max-w-[600px] h-[60px]  border-2 border-gray-700 rounded-2xl text-white font-semibold px-[20px] outline-none "
