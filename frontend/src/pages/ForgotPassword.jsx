...
function ForgotPassword() {
  ...
  const handleStep1 = async () => {
    ...
    setErr("");
    try {
      const result = await axiosInstance.post(`/auth/sendOtp`, { email });
  ...
  const handleStep2 = async () => {
    ...
    setErr("");
    try {
      const result = await axiosInstance.post(`/auth/verifyOtp`, {
        email,
        otp,
      });
      console.log(result.data);
  ...
  const handleStep3 = async () => {
    ...
    setLoading(true);
    try {
      const result = await axiosInstance.post(`/auth/resetPassword`, {
        email,
