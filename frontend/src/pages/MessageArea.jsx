...
function MessageArea() {
  ...
  const getAllMessages = async () => {
    try {
      const result = await axiosInstance.get(
        `/message/getAll/${selectedUser._id}`
      );
  ...
  return (
    <div className="w-full h-[100vh] bg-gradient-to-b from-[#522b9a]  to-[#19002e94] relative">
      <div className="w-full flex items-center gap-4 px-4 fixed top-0 z-[100] backdrop-blur-md bg-blue-00/40 border-b border-white/20 shadow-md">
      ...
      <div className="w-full h-[80%] pt-[100px]  px-[40px] flex flex-col gap-[50px] overflow-auto ">
        {messages &&
      ...
      <div className="w-full h-[80px] fixed bottom-0 flex justify-center items-center z-[100]">
        <form
          className="w-[90%] max-w-[800px] h-[80%] rounded-full bg-gray-900 flex items-center gap-[10px] px-[20px] relative"
